...
const NAV = [
  ...
  { to:"/profiles",          icon:"⇄", label:"Switch Profiles",     roles:["ADMIN","ANALYST","VIEWER"] },
...
export default function Sidebar() {
  ...
  return (
    <aside style={{ width:215, background:T.surface, borderRight:`1px solid ${T.border}`, padding:"12px 0", display:"flex", flexDirection:"column", flexShrink:0, overflowY:"auto" }}>
      {visible.map(n => (
