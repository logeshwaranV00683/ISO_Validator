...
export const updateGlobalPrompt = async (content, note) =>
  unwrap(await apiClient.put("/ai/prompts/global", { templateContent: content, changeNote: note }));
...
export const upsertProfilePrompt = async (profileId, content, note) =>
  unwrap(await apiClient.put(`/ai/prompts/profile/${profileId}`, { templateContent: content, changeNote: note }));
